...
const APP_SHELL = ['./', './index.html', './styles.css?v=1.32.7', './script.js?v=1.32.0', './exchange-rate.js', './weather.js?v=1.31.0', './pwa.js?v=1.30.0', './manifest.webmanifest', './icon.svg'];

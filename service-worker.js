...
const APP_SHELL = ['./', './index.html', './personal-tools.html', './styles.css?v=2.3.3', './personal-tools.css?v=2.1.0', './script.js?v=2.3.2', './personal-tools.js?v=2.1.0', './exchange-rate.js', './weather.js?v=1.31.0', './pwa.js?v=1.30.0', './manifest.webmanifest', './icon.svg'];
